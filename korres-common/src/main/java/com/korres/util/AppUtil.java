...
public class AppUtil  {
	...
	public static boolean checkParam(String method, PageData pd){
		...
		if(method=="registered"){// 注册
			paramArray = Constants.APP_REGISTERED_PARAM_ARRAY;  //参数
			valueArray = Constants.APP_REGISTERED_VALUE_ARRAY;  //参数名称
			
		}else if(method=="login"){//登录
			paramArray = Constants.APP_LOGIN_PARAM_ARRAY;  
			valueArray = Constants.APP_LOGIN_VALUE_ARRAY;
			
		}else if(method=="statusUtil"){//登录状态
			paramArray = Constants.APP_LOGINSTATUS_PARAM_ARRAY;  
			valueArray = Constants.APP_LOGINSTATUS_VALUE_ARRAY;
			...
			paramArray = Constants.APP_FORGOTPASSWORD_PARAM_ARRAY;
			valueArray = Constants.APP_FORGOTPASSWORD_VALUE_ARRAY;
