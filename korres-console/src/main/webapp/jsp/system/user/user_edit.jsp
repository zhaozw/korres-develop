...
$(document).ready(function(){
	...
	function hasU(){
		...
		var url = "user/hasU.htm?USERNAME="+USERNAME+"&tm="+new Date().getTime();
	...
	function hasE(USERNAME){
		var EMAIL = $("#EMAIL").val();
		var url = "user/hasE.htm?EMAIL="+EMAIL+"&USERNAME="+USERNAME+"&tm="+new Date().getTime();
		$.get(url,function(data){
			if(data=="error"){
	...
	function hasN(USERNAME){
		...
		var url = "user/hasN.htm?NUMBER="+NUMBER+"&USERNAME="+USERNAME+"&tm="+new Date().getTime();
		$.get(url,function(data){
			if(data=="error"){
...
<body>
	<form action="user/${msg }.htm" name="userForm" id="userForm" method="post">
